...
### Version 0.8.13 (2022-XX-XX)
  ...
  - 改进驾驶监控
  - 改进了comma two的相机对焦
  - 斯巴鲁Impreza 2020车型支持，感谢martinl的贡献!



### Version 0.8.12 (2021-12-15)

更多详细说明可以参考 https://blog.comma.ai/0812release/

  - 新的驾驶模式
    - 改进的退出行为
    - 高速下更好的姿势准确度，最高时速可达 90 英里/小时
    - 将comma three数据完全合并到训练堆栈的所有部分中
  - 改进的跟随距离
  - 更好的纵向政策，尤其是在低速交通中
  - 新的警报声音
  - AGNOS 3
    ...
    - 系统可靠性改进
    - 将 Python 更新至 3.8.10
  - 原始日志上传移至 connect.comma.ai
  - 修复了新本田博世的 HUD 警报，感谢csouers的贡献!
  - 奥迪 Q3 2020-21 车型支持，感谢 jyoung8607的贡献!
